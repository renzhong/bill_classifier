...
|qwen-flash-2025-07-28|prompt4.0|132条账单数据|81.06%|
|qwen3-max-2025-09-23|prompt4.0|132条账单数据|85.61%%|
|qwen3-max-2026-01-23|prompt4.0|132条账单数据|85.61%|
|qwen3-max-thinking|prompt4.0|132条账单数据|85.61%|
